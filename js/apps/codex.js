Apps.register({
    ...
    launch: () => {
        ...
        const style = `
            .cx-wrap { display: flex; flex: 1; color: var(--text); font-family: var(--font-sans); min-height: 0; }
            .cx-sidebar { width: 220px; flex-shrink: 0; background: var(--surface-sunk); border-right: 1px solid var(--line); display: flex; flex-direction: column; overflow-y: auto; padding: 16px 0; min-height: 0; }
            .cx-nav-item {
                padding: 10px 24px;
                cursor: pointer;
            ...
            .cx-nav-item:hover { opacity: 1; background: var(--surface-sunk); }
            .cx-nav-item.active {
                opacity: 1;
            ...
            .cx-content h2 { font-size: 20px; margin-top: 24px; margin-bottom: 12px; color: var(--accent); font-weight: 600; }
